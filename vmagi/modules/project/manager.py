...
"""
    ...
    def create_project(self, target_path: str, template: str = None) -> bool:
        ...
        try:
            ...
            with open(base / ".vmagi" / "project.yaml", "w", encoding="utf-8") as f:
            ...
            with open(base / ".vmagi" / "portability.json", "w", encoding="utf-8") as f:
    ...
    def open_project(self, target_path: str) -> dict:
        ...
        base = Path(target_path)
        yaml_path = base / ".vmagi" / "project.yaml"

        if not yaml_path.exists():
            raise FileNotFoundError("No es un proyecto MAGI válido (falta .vmagi/project.yaml)")
